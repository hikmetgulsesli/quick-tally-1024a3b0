...
- Quick Tally turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Quick Tally. It should show a title, one number counter, plus and minus icon buttons, and keep the count in local state. Keep it simple.
...
- Status Utility - Quick Tally

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Status Utility - Quick Tally
